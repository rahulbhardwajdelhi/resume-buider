...
import {
  LuArrowLeft, LuArrowRight, LuCircleAlert, LuDownload,
  LuPalette, LuSave, LuTrash2
} from "react-icons/lu";
    ...
    switch (currentPage) {
      case "profile-info":
        const { fullName, designation, summary } = resumeData.profileInfo;
          ...
          if (!summary.trim()) errors.push("Professional Summary is required.");
          break;

      case "contact-info":
        const { email, phone } = resumeData.contactInfo;
          if (!email.trim() || !/^\S+@\S+\.\S+$/.test(email)) errors.push("Email is required.");
      ...
      case "additionalInfo":
        if (
          ...
          errors.push("Please provide valid language details.");
        }
        ...
        if(
          ...
          errors.push("Please provide at least one interest.");
        }
        break;
  ...
  return (
    <DashboardLayout>
      <div className="container mx-auto">
        <div className="flex items-center justify-between gap-5 Ibg-white rounded-lg border border-purple-100 py-3 px-4 mb-4">
          <TitleInput
